...
const Sidebar = () => {
  return (
    <div>
      ...
      <p className="px-2 py-1 my-3 rounded-full bg-blue text-butter">
        Developer
        </p>
      <a className="flex items-center justify-center px-2 py-1 my-3 rounded-full bg-blue text-butter"
      href=""
   >
      ...
      {/* {social icon} */}
      <div className="flex justify-around w-9/12 mx-auto my-5 text-darkBlue md:w-full">
      ...
      <button className="w-8/12 px-5 py-2 my-2 rounded-full text-butter bg-blue" onClick={()=>window.open('mailto: yiyuchen9@gmail.com')}>
        Email Me
        </button>
      <button className="w-8/12 px-5 py-2 my-2 rounded-full text-butter bg-blue">
        Toggle Theme
        </button>
    </div>
  )
